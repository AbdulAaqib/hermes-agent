...
# Query-param auth styles (``?key=<token>``) are covered by match_query.
...
# interchangeable env-var names for the SAME upstream credential. The sandbox receives the minted token under the canonical name AND
