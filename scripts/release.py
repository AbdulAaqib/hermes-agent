...
LEGACY_AUTHOR_MAP = {
    ...
    "steve@lightpathapps.com": "slawt",  # PR #8427 salvage (OAuth2 token minting via service-account JSON / ADC on an OpenAI-compat endpoint, rewired as a provider profile with per-turn 401 token refresh)
    ...
    "pedro.m.simoes@gmail.com": "pmos69",  # PR #29474 salvage (native Antigravity OAuth provider)
    ...
    "patryk@jarmakowicz.me": "zwolniony",  # PR #26961 (x-goog-api-key auth)
